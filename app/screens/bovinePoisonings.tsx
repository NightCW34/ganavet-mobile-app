  ...
  return (
    <View>
      <ScrollView>
        ...
        <Text style={styles.text}>
          • Higuera (Ficus spp.): Las higueras • Hedionda (Ruta graveolens): La
          hedionda es tóxica y puede causar fotosensibilidad en el ganado, lo
          que resulta en daño en la piel y otros problemas de salud.
        </Text>
        <Text style={styles.text}>
